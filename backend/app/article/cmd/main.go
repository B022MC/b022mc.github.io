...
import (
	...
	"github.com/b022mc/b022mc.github.io/backend/app/article/internal/data"
	"github.com/b022mc/b022mc.github.io/backend/app/article/internal/server"
	"github.com/b022mc/b022mc.github.io/backend/app/article/internal/service"
)
...
func main() {
	...
	if c.Server.GRPC.Addr == "" {
		c.Server.GRPC.Addr = "0.0.0.0:9001"
	}
	...
	articleSvc := service.NewArticleService(articleUc, logger)

	gs := server.NewGRPCServer(&c, articleSvc, logger)
